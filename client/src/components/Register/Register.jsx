...
function Register() {
    ...
    return (
        <div className="bg-[#E6D5B8] p-10 rounded-[40px] w-[350px] shadow-sm flex flex-col items-center">
            <h2 className="text-[#5D4037] text-3xl font-bold mb-10">Inscription</h2>
            ...
            <div className="mt-8 text-center text-sm">
                <p className="text-[#8C6A5E] font-medium">Déjà inscrit ?</p>
                <button onClick={() => navigate("/login")}className="text-[#7B824B] font-bold hover:underline">
                    S'inscrire
                </button>
            </div>
        </div>
